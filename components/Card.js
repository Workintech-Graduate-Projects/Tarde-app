...
const Card = ({ click ,setClick}) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `http://localhost:9000/api/table/admin/aracsayisi/sehir/${click}`
        );
    ...
    const fetchMerkez = async () => {
      try {
        const response = await axios.get(
          `http://localhost:9000/api/table/admin/merkez`
        );
        setDataMerkez(
  ...
  useEffect(() => {
    const fetchDataSehir = async () => {
      try {
        const response = await axios.get(
          `http://localhost:9000/api/table/admin/isbirligi/${click}`
        );
